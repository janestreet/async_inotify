(* OASIS_START *)
(* DO NOT EDIT (digest: e7558b779c97a4bc072d86e8d83b3d47) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_inotify", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_inotify", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_inotify";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("inotify", None);
                           FindlibPackage ("async", None);
                           FindlibPackage ("async_find", None);
                   ...
                   {
                      lib_modules = ["Async_inotify"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "async_inotify";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Async wrapper for inotify";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "#\220\131\206\1559\136)/V\181\188\181\212\162\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
